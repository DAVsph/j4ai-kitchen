...
export async function POST(req:NextRequest){try{
 ...
 const common=`Photographie d'architecture intérieure réaliste et haut de gamme. Brief client: ${brief}. PRIORITÉ ABSOLUE : respecter la pièce existante et toutes les contraintes décrites par le client. Ne jamais supprimer, déplacer, ajouter ni modifier une fenêtre, baie vitrée, porte, ouverture, radiateur, cheminée, poteau, poutre, escalier, arrivée/évacuation d'eau, équipement fixe ou autre élément architectural mentionné. Respecter leur nombre, leur position relative, leurs proportions et les circulations. Si une information est inconnue, ne pas l'inventer comme une certitude. Le mobilier et la décoration doivent s'adapter à l'architecture existante, jamais l'inverse. Le rendu est uniquement illustratif. Ne jamais affirmer une faisabilité technique, une conformité aux normes, des dimensions exactes, un prix, une marque ou un matériau non fourni. Conserver des proportions visuellement plausibles. Sans texte ni logo.`
